...
![Gráfico de barras horizontal - Riscos Econômicos Imediato 2025](assets/economicos/grafico_barras_imediato_2025.png)

::: {.callout-note title="Destaques do período Imediato de 2025"}
- **Instabilidade política**: 50% das respostas em níveis altos (4-5);
- **Excesso regulatório**: 46% em níveis altos;
- **Aumento de impostos**: 46% em níveis altos.
:::
...
### Especulação e crise no mercado de ativos financeiros

![](assets/economicos/grafico_agrupado_1_1_temporal.png)

::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 28% em risco alto

**Curto Prazo (2026-2027)**: Mediana 3.0, 25% em risco alto

**Longo Prazo (até 2035)**: Mediana 3.0, 32% em risco alto
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 22% em risco alto
...
- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Concentração de recursos estrategicamente importantes (minerais, materiais, tecnologias) entre um pequeno número de indivíduos, empresas ou Estados que podem controlar o acesso e ditar preços discricionários. \[Imediato (2025)\]**
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 36% em risco alto

**Curto Prazo (2026-2027)**: Mediana 3.0, 42% em risco alto

**Longo Prazo (até 2035)**: Mediana 3.0, 41% em risco alto

- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Endividamento público. \[Imediato (2025)\]**
...
**Curto Prazo (2026-2027)**: Mediana 3.0, 27% em risco alto

**Longo Prazo (até 2035)**: Mediana 3.0, 32% em risco alto

- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Endividamento empresarial. \[Imediato (2025)\]**
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 2.0, 26% em risco alto
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 40% em risco alto

**Curto Prazo (2026-2027)**: Mediana 4.0, 50% em risco alto
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 45% em risco alto

**Curto Prazo (2026-2027)**: Mediana 3.0, 43% em risco alto

**Longo Prazo (até 2035)**: Mediana 3.0, 40% em risco alto

- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Disrupções em infraestruturas críticas (físicas e digitais) ou serviços que sustentam sistemas críticos (internet, telecomunicações, serviços públicos, sistemas financeiros ou energia).**
...
- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Aumento da inflação. \[Imediato (2025)\]**
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 27% em risco alto
...
- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Dificuldades de financiamento e obtenção de recursos financeiros para investimento. \[Imediato (2025)\]**
...
![](assets/economicos/grafico_agrupado_1_12_temporal.png)

::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 23% em risco alto

**Curto Prazo (2026-2027)**: Mediana 3.0, 30% em risco alto

**Longo Prazo (até 2035)**: Mediana 3.0, 30% em risco alto

- **Tendência**: Percepção estável, com leve elevação ao passar para o curto prazo.
**Riscos reputacionais. Referem-se à possibilidade de danos à reputação de uma organização devido a eventos, comportamentos, práticas ou percepções negativas.**

Mesmo em um ambiente operacional com controles consolidados, incidentes comunicacionais e falhas de governança rapidamente repercutem sobre a legitimidade dos terminais. A estabilidade das medianas evidencia que o risco é estrutural: não cresce de forma acelerada, mas exige vigilância permanente, protocolos de relacionamento com stakeholders e respostas coordenadas para preservar a confiança na operação portuária.

:::

### Risco de competitividade portuária

![](assets/economicos/grafico_agrupado_1_13_temporal.png)

::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 35% em risco alto

**Curto Prazo (2026-2027)**: Mediana 3.0, 41% em risco alto

**Longo Prazo (até 2035)**: Mediana 4.0, 51% em risco alto

- **Tendência**: Escalada contínua, culminando em patamar crítico no longo prazo.
**Risco de competitividade portuária. Riscos relacionados à concorrência entre portos referem-se às ameaças e desafios enfrentados diante de players que oferecem serviços de custo menor ou maior eficiência operacional.**

A pressão competitiva aparece de forma moderada no imediato, mas cresce rapidamente à medida que novos investimentos e corredores logísticos surgem. O salto da mediana para 4.0 no horizonte de 2035 indica que os portos precisarão sustentar produtividade, diferenciação de serviços e alianças estratégicas de longo prazo para manter posição nos fluxos globais.
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 46% em risco alto

**Curto Prazo (2026-2027)**: Mediana 4.0, 54% em risco alto

**Longo Prazo (até 2035)**: Mediana 4.0, 53% em risco alto

- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Aumento de impostos.**

A condição de aumento de impostos tem de ser analisada em relação às condições de concorrência e à possibilidade de mercado de repassá-los a clientes e parceiros.
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 25% em risco alto
...
Risco estratégico que transcende a esfera operacional e impacta diretamente a governança e sustentabilidade das operações portuárias. Decorre da dinâmica democrática e da alternância de poder, especialmente em portos públicos onde mudanças administrativas podem ocorrer com a transição de grupos políticos.
...
**Curto Prazo (2026-2027)**: Mediana 3.0, 47% em risco alto
...
**Curto Prazo (2026-2027)**: Mediana 3.0, 36% em risco alto
...
::: {.callout-tip title="Destaques"}
**Imediato (2025)**: Mediana 3.0, 38% em risco alto

**Curto Prazo (2026-2027)**: Mediana 3.0, 46% em risco alto

**Longo Prazo (até 2035)**: Mediana 3.0, 38% em risco alto
...
- **Tendência**: Percepção de risco relativamente estável ao longo do tempo.
**Conflito ou instabilidade institucional do Estado. \[Imediato (2025)\]**
